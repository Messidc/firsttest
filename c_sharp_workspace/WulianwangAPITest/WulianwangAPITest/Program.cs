...
namespace WulianwangAPITest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //string sss2 = Post2("http://www.189iot.cn:8832/wlwManage/api/orderCommand.do", body2, jp.accessToken);
        ...
        /// <param name="jsonParas"></param>
        /// <returns></returns>
        public static string PostAddDevice(string Url, string jsonParas, string para)
        {
            string strURL = Url;
